                    ...
                    if (cNode.GetAttributeValue("class", string.Empty) == "col-xs-6 col-sm-3 col-md-3 text-left")
                    {
                        ...
                        if (link.StartsWith("http://"))
                        {
                            ...
                            switch(type)
                            {
                                ...
                                case "SCLA":        // 无法播放 "http://itv3.ahau.edu.cn/vms/videos/channellive/channel" + channel + "/playlist.m3u8"
                                ...
                                default:
                                    System.Diagnostics.Debug.WriteLine("不识别的安徽农大视频源");
                                    continue;
                            }
                        }
                        // 剩下的开头都是prplayer.html
                        ...
                        else
                        {
                            ...
                            switch (type)
                            {
                                ...
                                case "nnlive":  // 无法播放 "http://itv{serverCode}.ahau.edu.cn/nn_live.flv?id={channelCode}"
